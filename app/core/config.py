...
class Settings(BaseSettings):
    ...
    epd_url: str = Field(default="wss://api.magovoice.com/epdx/", alias="EPD_URL")
    epd_language: str = Field(default="ko", alias="EPD_LANGUAGE")
    epd_min_confidence: float = Field(default=0.3, alias="EPD_MIN_CONFIDENCE")
    epd_ready_timeout: float = Field(default=5.0, alias="EPD_READY_TIMEOUT")
